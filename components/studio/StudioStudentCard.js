  ...
  return (
    <div className="bg-white rounded-lg shadow-lg p-4 md:p-6 mb-6">
      <div className="flex">
        ...
        {/* </button> */}
        <h3 className="text-gray-600 ml-auto coustard">{studioStudentObj.student_id.instrument}</h3>
      </div>
      ...
      <div className="pt-4 flex justify-between">
        <button onClick={unenroll} type="button" className="bg-orange-400 hover:bg-orange-300 text-white px-3 pb-1 pt-2 rounded">
