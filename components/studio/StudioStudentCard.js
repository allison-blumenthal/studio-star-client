...
function StudioStudentCard({ studioStudentObj, onUpdate }) {
  ...
  return (
    <div className="bg-blue-100 rounded-lg shadow-lg p-4 md:p-6 mb-6 max-w-lg">
      <div className="flex">
        {/* <button onClick={handleProfile} type="button"> */}
        <h2 className="text-lg font-semibold bevan mb-2">
          {studioStudentObj.student_id.first_name} {studioStudentObj.student_id.last_name}
        </h2>
        {/* </button> */}
        <h3 className="text-blue-900 ml-auto coustard text-lg">{studioStudentObj.student_id.instrument}</h3>
      </div>
      <h3 className="text-gray-600 mb-2 coustard italic">{studioStudentObj.student_id.pronouns}</h3>
      ...
      <div className="pt-4 flex justify-between">
        <button onClick={unenroll} type="button" className="bg-yellow-400 hover:bg-yellow-200 text-white px-3 pb-1 pt-2.5 rounded">
