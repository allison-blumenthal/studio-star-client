...
function AssignmentCard({ assignmentObj, onUpdate }) {
  ...
  return (
    <div className="mx-4 md:max-w-sm lg:max-w-md rounded bg-gray-100 shadow-lg p-3 transition-opacity duration-100 ease-in-out hover:bg-gray-300">
      <h3 className="text-blue-700 text-center text-lg bevan p-2">{formattedDate}</h3>
